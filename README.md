...
**How it works:**
1. When you add a directory via `/add-dir` or `add_directory`, it's saved to `$XDG_CONFIG_HOME/pi-add-dir/dirs/<cwdHash>.json`
...
| Platform | Path |
|----------|------|
| Unix (XDG) | `$XDG_CONFIG_HOME/pi-add-dir/dirs/<hash>.json` |
| Windows | `%APPDATA%/pi-add-dir/dirs/<hash>.json` |
| Fallback | `~/.config/pi-add-dir/dirs/<hash>.json` |
